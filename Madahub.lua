local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Jfdedit3/Mada-ui/refs/heads/main/Madzhubui"))()
workspace.FallenPartsDestroyHeight = -math.huge

local Window = Library:MakeWindow({
    Title = "Mada Hub 3.9 | Brookhaven RP ",
    SubTitle = "by: Mada",
    LoadText = "Loading Mada hub",
    Flags = "Zzz4trox_Broookhaven"
})
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://77855434347030", BackgroundTransparency = 0 },
    Corner = { CornerRadius = UDim.new(35, 1) },
})

local InfoTab = Window:MakeTab({ Title = "Info", Icon = "rbxassetid://77855434347030" })



InfoTab:AddSection({ "Script Information" })
InfoTab:AddParagraph({ "Owner / Developer:", "Mada" })
InfoTab:AddParagraph({ "My acc", "z4trox1 (Roblox)" })
InfoTab:AddParagraph({ "Origin:", "French script" })
InfoTab:AddParagraph({ "Friends :", "Akxii" })
local name, version = identifyexecutor()
InfoTab:AddParagraph({ "Your executor:", tostring(name .. " " .. (version or "")) })
...
createMusicDropdown("New codes by Akxii & Mada", {
    ["Madou"] = {
        {name = "Music 1", id = "96223086135288"},
        {name = "Music 2", id = "80642665839166"},
        {name = "Music 3", id = "91986879922479"},
        {name = "Music 4", id = "125784363463466"},
        {name = "Music 5", id = "84031748451867"},
        {name = "Music 6", id = "128771129962214"},
        {name = "Music 7", id = "136893418307185"},
        {name = "Music 8", id = "71782154359434"},
        {name = "Music 9", id = "133757202237498"},    
        {name = "Music 10", id = "116319055329754"},
        {name = "Music 11", id = "81102632991320"},
        {name = "Music 12", id = "72451271928975"},
        {name = "Music 13", id = "107027481244497"},
        {name = "Music 14", id = "124916012752607"},
        {name = "Music 15", id = "87815326856085"},
        {name = "Music 16", id = "138052729291665"},
        {name = "Music 17", id = "85342086082111"},
        {name = "Music 18", id = "16190756998"},
        {name = "Music 19", id = "16190784875"},
        {name = "Music 20", id = "112723885774179"},
        {name = "Music 21", id = "102268180683654"},
        {name = "Music 22", id = "98199198727548"},
        {name = "Music 23", id = "105721916543931"},
        {name = "Music 24", id = "111668097052966"},
        {name = "Music 25", id = "136671968495863"},
        {name = "Music 26", id = "132311372545619"},
        {name = "Music 27", id = "124648098849708"},
        {name = "Music 28", id = "98184705510569"}
        {name = "Music 29", id = "110175139101701"},
        {name = "Music 30", id = "117897345275675"},
        {name = "Music 31", id = "131314026811082"},
        {name = "Music 32", id = "116616553316934"},
        {name = "Music 33", id = "111668097052966"},
        {name = "Music 34", id = "79748889460505"},
        {name = "Music 35", id = "16831105312"},
        {name = "Music 36", id = "103409297553965"},
        {name = "Music 37", id = "104575671082804"},
        {name = "Music 38", id = "74502909274097"},
        {name = "Music 39", id = "73263182682604"},
        {name = "Music 40", id = "79524568159484"},
        {name = "Music 41", id = "120785124326826"},
        {name = "Music 42", id = "79748889460505"},
        {name = "Music 43", id = "106213657249605"},
        {name = "Music 44", id = "111668097052966"},
        {name = "Music 45", id = "16190760005"},
        {name = "Music 46", id = "15689448519"},
        {name = "Music 47", id = "119124779781239"},
        {name = "Music 48", id = "98337901681441"},
        {name = "Music 49", id = "98629346350551"},
        {name = "Music 50", id = "109444527994966"},
        {name = "Music 51", id = "16831105312"},
        {name = "Music 52", id = "114608169341947"},
        {name = "Music 53", id = "123700514069374"},
        {name = "Music 54", id = "77726412497289"},
        {name = "Music 55", id = "129071695986627"},
        {name = "Music 56", id = "121703297529684"},
        {name = "Music 57", id = "74258284867725"},
        {name = "Music 58", id = "120342836549924"},
        {name = "Music 59", id = "102308486921520"},
        {name = "Music 60", id = "82696338249251"},
        {name = "Music 61", id = "121205882949035"},
        {name = "Music 62", id = "16190756998"},
        {name = "Music 63", id = "16190784875"},
        {name = "Music 64", id = "133798757706866"},
        {name = "Music 65", id = "104640549125486"},
        {name = "Music 66", id = "129564709610140"},
        {name = "Not 67 :(", id = "94835387971754"},
        {name = "Music 68", id = "88900228893875"},
        {name = "Music 69", id = "96820165642825"},
        {name = "Music 70", id = "91557236521456"},
        {name = "Music 71", id = "74414995120556"},
        {name = "Music 72", id = "71720989209657"},
        {name = "Music 73", id = "138169420138339"},
        {name = "Music 74", id = "98574019808252"},
        {name = "Music 75", id = "97382282509122"},
        {name = "Music 76", id = "122039713538884"},
    }
}, "Option 1")

createMusicDropdown("Random Memes", {
    ["forro"] = {
...
local BrookMusicTab = Window:MakeTab({
    Title = "Brook Music",
    Icon = "music"
})
...
BrookMusicTab:AddTextBox({
    ...
    Description = "Enter Music ID for Overboard/Skate",
    PlaceholderText = "Overboard/Skate Music ID",
...
BrookMusicTab:AddTextBox({
    Name = "House Music",
    Description = "Enter Music ID for House",
    PlaceholderText = "House Music ID",
    Callback = function(val)
        if val ~= "" then
            local num = tonumber(val)
            if num then
                local args = {[1] = "PickHouseMusicText", [2] = val}
                local RE = game:GetService("ReplicatedStorage"):FindFirstChild("RE")
                if RE then
...
local function safeLoad(url, name)
    ...
    if not success then
        warn("Erreur lors du chargement de '" .. name .. "': " .. tostring(result))
        return
    end

    local success, err = pcall(result)
    if not success then
        warn("Erreur lors de l'exécution de '" .. name .. "': " .. tostring(err))
    else
        print("Script '" .. name .. "' chargé avec succès.")
    end
end

-- Création de l'onglet Mada Script
local MadaScriptTab = Window:MakeTab({
    Title = "Mada Script", -- Utilisation de 'Title' au lieu d'une table
    Icon = "home"         -- Utilisation de 'Icon' au lieu d'une table
})
MadaScriptTab:AddSection({
    Title = "Mada Script Scripts" -- Utilisation de 'Title' au lieu d'une table
})
...
MadaScriptTab:AddButton({
    ...
    Callback = function()
        safeLoad("https://raw.githubusercontent.com/Jfdedit3/KOLINSKI/refs/heads/main/KOLINSKI.lua", "KOLINSKI Admin") -- URL corrigée
    end
})
...
MadaScriptTab:AddButton({
    ...
    Callback = function()
        safeLoad("https://raw.githubusercontent.com/Jfdedit3/Nameless-admin/refs/heads/main/Source", "Mada Admin") -- URL corrigée
    end
})
...
MadaScriptTab:AddButton({
    ...
    Callback = function()
        safeLoad("https://raw.githubusercontent.com/Jfdedit3/Nameless-music-lunch/refs/heads/main/Main", "Nameless Music") -- URL corrigée
    end
})
...
MadaScriptTab:AddButton({
    ...
    Callback = function()
        safeLoad("https://pastebin.com/raw/0ADPHjNE", "Mada Jims RNG") -- URL corrigée
    end
})

-- Création de l'onglet Musique
local MusicTab = Window:MakeTab({
    Title = "Music fe", -- Utilisation de 'Title' au lieu d'une table
    Icon = "music"   -- Utilisation de 'Icon' au lieu d'une table
})
...
MusicTab:AddTextBox({
    ...
    Callback = function(val)
        if val ~= "" then
            local num = tonumber(val)
            -- Vérifier que c'est un nombre, entier et positif
...
local presets = {"107764433772204", "16662830706", "1836142077", "112723885774179", "139183666483872"}
...
-- Ajout de l'onglet Brook Music
local BrookMusicTab = Window:MakeTab({
    Title = "Brook Music",
    Icon = "music"
})

-- Bouton pour Spawn un Skateboard
BrookMusicTab:AddButton({
    Name = "Skate",
    Description = "Spawns a Skateboard",
    Callback = function()
...
-- Bouton pour Spawn un SegwaySmall (Overboard) - CORRIGÉ
BrookMusicTab:AddButton({
    Name = "Overboard",
    Description = "Spawns a SegwaySmall",
    Callback = function()
        ...
        if RE then
            ...
            if event then
                event:FireServer(unpack(args))
            end -- Fin du 'if event then'
        end -- Fin du 'if RE then'
    end
})

-- Zone de texte pour entrer l'ID de la musique pour le Skateboard/Segway
BrookMusicTab:AddTextBox({
    Name = "Overboard Music",
    Description = "Enter Music ID for Overboard/Skate",
    PlaceholderText = "Overboard/Skate Music ID",
    Callback = function(val)
        if val ~= "" then
            ...
            if num then
                ...
                local RE = game:GetService("ReplicatedStorage"):FindFirstChild("RE")
                if RE then
                    local event = RE:FindFirstChild("1NoMoto1rVehicle1s") -- Utilise le même RE pour les véhicules non motorisés
                    if event then
                        event:FireServer(unpack(args))
                    end
                end
...
-- Zone de texte pour entrer l'ID de la musique pour la maison
BrookMusicTab:AddTextBox({
    Name = "House Music",
    Description = "Enter Music ID for House",
    PlaceholderText = "House Music ID",
    Callback = function(val)
        if val ~= "" then
            ...
            if num then
                ...
                local RE = game:GetService("ReplicatedStorage"):FindFirstChild("RE")
                if RE then
                    local event = RE:FindFirstChild("1Player1sHous1e") -- Utilise le RE pour les maisons
                    if event then
                        event:FireServer(unpack(args))
                    end
                end
...
TrollTab:AddButton({
    Name = "Black Hole",
    Description = " Activating this allows you to pull Parts to your character.",
    Callback = function()
...
TrollTab:AddButton({
    Name = "Becoming Invisible",
    Description = "Stay invisible FE",
Callback = function()
...
TrollTab:AddToggle({
    Name = "RGB hair",
    Description = "Leaves Your Hair RGB",
    Default = false,
    Callback = function(value)
        isActive = value
        if isActive then
...
TrollTab:AddToggle({
    Name = "Anti Sit",
    Description = "it doesnt make you sit at all",
    Default = false,
    Callback = function(Value)
...
local function KillPlayerCouch()
    if not selectedPlayerName then
        warn("Erro: No players selected")
        return
    end
    local target = Players:FindFirstChild(selectedPlayerName)
    if not target or not target.Character then
        warn("Erro: Target player not found or no character")
        return
    end

    local char = LocalPlayer.Character
    if not char then
        warn("Erro: Local player character not found")
        return
    end
    ...
    if not hum or not root or not tRoot then
        warn("Erro: Required components not found")
        return
    end
...
local function BringWithCouch()
    ...
    if not targetPlayer then
        warn("Erro: No target players selected")
        return
    end
    if not targetPlayer.Character or not targetPlayer.Character:FindFirstChild("HumanoidRootPart") then
        warn("Erro: Target player without a character or HumanoidRootPart")
        return
    end
    ...
    if not couch then
        warn("Erro: Sofa not found in Backpack")
        return
    end
    ...
    if seat1 and seat2 and handle then
        ...
        warn("Erro: Sofa components not found")
        return
    end
    ...
    Troll:AddButton({
        ...
        Callback = function()
            ...
            if killDropdown and #tablePlayers > 0 then
                ...
                print("Updated player list: ", table.concat(newPlayers, ", "))
                ...
                print("Erro: Dropdown not found or no players available.")
            end
        end
    })
    ...
    Troll:AddButton({
        ...
        Callback = function()
            if not selectedPlayerName or not Players:FindFirstChild(selectedPlayerName) then
                print("Erro: Player not selected or does not exist")
                return
            end
            local character = LocalPlayer.Character
            local humanoidRootPart = character and character:FindFirstChild("HumanoidRootPart")
            if not humanoidRootPart then
                warn("Erro: HumanoidRootPart of the local player not found")
                return
            end
            ...
            if targetPlayer and targetPlayer.Character and targetPlayer.Character:FindFirstChild("HumanoidRootPart") then
                ...
                print("Erro: Target player not found or missing HumanoidRootPart")
            end
        end
    })
                            ...
                            if targetPlayer and targetPlayer.Character and targetPlayer.Character:FindFirstChild("HumanoidRootPart") then
                                ...
                                if targetHumanoid and targetHumanoid.Sit then
                                    if character.Humanoid then
                                        ...
                                        print("The player sat down, taking the bus to the void!")
                                        task.wait(0.2)
                                        ...
                                        print("The player returned to the starting position.")
                                    end
                                    break
                                else
...
Troll:AddButton({
    ...
    Callback = function()
        ...
        print("Player paralyzed to reduce the effects of the spin.")
        ...
        print("Spin and forces removed from the player.")
        ...
        print("The player is trapped at the safe coordinates.")
        ...
        print("Player cleared to play, secure in his position.")
    end
})
...
Description = "To use, I recommend getting close to other doors; after it comes to you, click on the player you want to fling with.",
  Callback = function()
local Players = game:GetService("Players")
local Workspace = game:GetService("Workspace")
local RunService = game:GetService("RunService")
            ...
            if targetPlayer and targetPlayer.Character and targetPlayer.Character:FindFirstChild("HumanoidRootPart") then  
                ...
                if targetHumanoid and targetHumanoid.Sit then  
                    ...
                    if bus then
                        ...
                        simulateJump()  
                        print("Simulating the first jump!")  

                        task.wait(0.4)  
                        simulateJump()
                        print("Simulating a second jump!")  

                        task.wait(0.5)
                        if originalPosition then
                            Players.LocalPlayer.Character.HumanoidRootPart.CFrame = originalPosition  
                            print("Player returned to the initial position Xique")  
...
picktoolremote = game:GetService("ReplicatedStorage").RE:FindFirstChild("1Too1l")
cleartoolremote = game:GetService("ReplicatedStorage").RE:FindFirstChild("1Clea1rTool1s")
game:GetService("StarterGui"):SetCore("SendNotification",{Title="Dupping",Text="Don't click on anything", Button1 = "Okay!" ,Duration=5})
game:GetService("StarterGui"):SetCore("SendNotification",{Title="Dupping",Text="Wait", Button1 = "Df?" ,Duration=5})
duping = true
oldcf = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
if game.Players.LocalPlayer.Character.Humanoid.Sit == true then
    task.wait()
...
for m=1, dupeamot do
    ...
    elseif m == dupeamot or m >= dupeamot - 1 then
        game:GetService("StarterGui"):SetCore("SendNotification",{Title="Dupe Script",Text="Now you have".." "..m.." ".."Duped".." "..toolselcted.."!".." ".."The tools are being duplicated. Don't click on anything.",Duration=4})
    end
    local args = {
        [1] = "PickingTools",
        [2] = toolselcted
...
local HouseTab = Window:MakeTab({"Home", "home"})
...
pcall(function()
    HouseTab:AddSection({ Name = "Teleport to Homes" })
end)
...
pcall(function()
    HouseTab:AddLabel("You automatically unban houses")
end)

-- Seção para Casa RGB
pcall(function()
    HouseTab:AddSection({ Name = "Home RGB" })
end)
...
-- Label após Casa RGB
pcall(function()
    HouseTab:AddLabel("Make your home RGB")
end)
...
Tab:AddTextBox({
    Name = "Enter the Audio or Music ID",
...
Tab:AddParagraph({"Info", "Audio loop (All players on the server can hear it)"})
...
Tab:AddToggle({
    Name = "Bursting everyone's ears KK",
...
Tab:AddParagraph({"Info", "Everyone on the server can hear the audio"})
...
Tab:AddButton({
    Name = "Shutdown Servidor (Internet Error)",
    Callback = function()
        for m = 1, 535 do
            local args = {
                [1] = "PickingTools",
...
Tab:AddButton({
    Name = "Server Shutdown (Connection Timed Out Error)",
    Callback = function()
        for m = 1, 635 do
            local args = {
                [1] = "PickingTools",
...
Tab:AddParagraph({
    "Lag Information",
    "The lag effect begins after 35 seconds"
})
...
Tab:AddToggle({
    ...
    Callback = function(value)
        isBioActive = value
        print(value and "RGB BIO activated" or "RGB BIO disabled")
    end
})
...
CarTab:AddParagraph({"Note: The music script works in all cars and homes."})
...
LocalPlayerTab:AddToggle({
    ...
    Callback = function(bool)
        ...
        if not selectedHeadSit or selectedHeadSit == "" then
            warn("No players selected for Head Sit!")
            return false
        end
        ...
        if bool then
            if selectedPlayer and selectedPlayer.Character then
                ...
                warn("Selected player not found or missing character!")
                return false
            end
        else
            if headSitConnection then
...
local Tab = Window:MakeTab({"Teleports", "tp"}) -- Nome do ícone: 'portal' em minúsculo para teleporte

-- Botões de Teleporte
local teleportButtons = {
    {"Behind the Scenes", CFrame.new(192, 4, 272)},
    {"To the Urban Center", CFrame.new(136, 4, 117)},
    ...
    {"To Café Brook", CFrame.new(161, 8, 52)},
    {"Back to the Starting Point", CFrame.new(-26, 4, -23)},
    {"To the Main Arch", CFrame.new(-589, 141, -59)},
    {"To the Hospital", CFrame.new(-309, 4, 71)},
    {"At the Agency's Base", CFrame.new(179, 4, -464)},
    {"To the Hidden Room of the Workshop", CFrame.new(0, 4, -495)},
    ...
    {"Climbing Mountain 1", CFrame.new(-670, 251, 765)},
...
ToolsTab:AddDropdown({
    Name = "Select the Color Combination",
